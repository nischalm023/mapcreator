...
Senior QA Engineer Test Automation Suite. All testing code is isolated in the `qa-studio/playwright-setup-858f4ac8` branch.

## QA Workflow & Guidelines
1. **Branch Isolation**: All testing activities run on `qa-studio/playwright-setup-858f4ac8`. Never modify the default/main branch or application production code.
